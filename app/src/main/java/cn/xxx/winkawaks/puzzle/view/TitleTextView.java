...
public class TitleTextView extends ViewGroup {
    private static final String FONTS_FOLDER = "fonts";
    private static final String FONT_TITLE = FONTS_FOLDER
    ...
    public void setText(String text, final Animation animation, int duration) {
        ...
        final Typeface font = Typeface.createFromAsset(assets, FONT_TITLE);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            childLeft = (int) (width - 2.5 * measuredWidth + i * measuredWidth);

            //将他们横向排列
            childView.layout(childLeft, height, childLeft + measuredWidth, height + measureHeight);
        }
    }
